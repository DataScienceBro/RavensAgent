...
def matchObjectFeatures(fMatA, fMatB):
    ...
    if (len(fMatB[0]) == 1):
        ...
        # the larger the difference between the closest object pairing and teh 2nd closest object pairing indicates confidence
...
def matchObjects(problem, rel, fMats):
    ...
    for node0, neighbors in rel.items():
        ...
        for node1 in neighbors:
            ...
            aliasPair = extractAliasPairing((problem.figures[node0], problem.figures[node1]), debug) #better for attribute dict descriptors of verbal image
